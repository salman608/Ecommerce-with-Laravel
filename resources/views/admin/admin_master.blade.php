  ...
  <body>
    ...
    <!-- ====Products Menu===== -->
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('admin.add-product')}}" class="nav-link @yield('add-product')">Add Product</a></li>
          <li class="nav-item"><a href="{{route('admin.menage-product')}}" class="nav-link @yield('menage-product')">Menage Product</a></li>
        </ul>
{{--          Order product--}}
