        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <div class="product__details__price">{{$product->product_price}} TK</div>
                    ...
                    <button  class="primary-btn " style="display:inline-block">ADD TO CARD</button>
                  </form>
                    <a href="{{route('add-wishlist',$product->id)}}" class="heart-icon"><span class="icon_heart_alt"></span></a>
                    <ul>
